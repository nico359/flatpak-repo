So here you can find the flatpak repo to my vibe coded apps. If you want to know more about each app, please see the respective Github page.
All of the apps aim to be mobile friendly for devices such as the Pine- or Furiphone.

Please see the release section for the .flatpakrepo file https://github.com/nico359/flatpak-repo/releases
